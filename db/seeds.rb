...
Contributor.create!([
  {
    ...
    bio:
      %( Eric is an Open Source Contributor, Rubyist, and Full-stack engineer. He lives in Aliso Viejo, California
         ).squish,
    image_filename: "contributors/eric.jpg",
...

  {
    ...
    title: "Full-stack Ruby on Rails Engineer, Agency of Learning",
    bio:
      %(Shami is an Open Source Contributor, Rubyist, and Full Stack Developer from the Rails community. He lives in 
...

  {
    ...
    bio:
      %(Daniel is a senior software developer who specializes in back-end development with Ruby on Rails but 
        is comfortable working in multiple languages. Daniel lives in Costa Mesa, California.
         ).squish,
...

  {
    ...
    bio:
      %(Katya is a junior UX developer from the Rails community who completed her web development bootcamp at Le Wagon 
